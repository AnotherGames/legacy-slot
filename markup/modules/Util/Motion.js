...
export let motionPath = (() => {
    ...
    let motion = {
        ...
        _calcPath: function ({
            ...
            for (let i = 0; i <= 1; i += x) {
                let pathX = game.math.bezierInterpolation(points.x, i);
                let pathY = game.math.bezierInterpolation(points.y, i);
                let node = {x: pathX, y: pathY, angle: 0};
                ...
                if (rectPath) {
                    bmd.rect(pathX, pathY, 1, 1, 'rgba(255, 255, 255, 1)');
                }
            }
