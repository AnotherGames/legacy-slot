...
export let view = (() => {
    ...
    let draw = {
        ...
        RulesScreen: function (container) {
            ...
            const closed = game.add.sprite(infoRules.width + 70, 70, 'closed', null, container);
            model.el('closed', closed);
            const arrowRight = game.add.sprite(infoRules.width / 2 + 170, infoRules.height + 30, 'ar', null, container);
            model.el('arrowRight', arrowRight);
            const arrowLeft = game.add.sprite(infoRules.width / 2 - 30, infoRules.height + 30, 'arLeft', null, container);
            model.el('arrowLeft', arrowLeft);

            let infoMarkers = [];
            let infoMarker = game.add.sprite(infoRules.width / 2 + 20, infoRules.height + 10, 'infoMarker', 'marker_on.png', container);
